          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
                Your AI pair programmer on the go. Seamlessly integrate
                planning, reasoning, and execution directly from your mobile
                device.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed">
                  Ask anything about your code. Get instant, accurate answers
                  and suggestions based on your codebase.
                </p>
              </motion.div>
