  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      <main className="pt-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  We specialize in Cross-platform Mobile and Progressive Web
                  Apps (PWA) that integrate seamlessly into your daily life.
                  Whether it's checking the weather, catching a bus, or coding
                  on the go, our tools are designed to be there when you need
                  them.
                </p>
              </div>
        ...
        <footer
          id="contact"
          className="bg-slate-900 text-slate-400 py-12 relative"
        >
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-tri"></div>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div>
                <h4 className="font-bold text-lg mb-4 font-brand text-gradient-tri">
            ...
            <div className="border-t border-slate-800 pt-8 text-center text-xs">
              &copy; {new Date().getFullYear()} ByteLand Technology Limited. All
              rights reserved.
            </div>
          </div>
        </footer>
