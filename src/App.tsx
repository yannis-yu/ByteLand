            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="h-48 bg-slate-900 flex items-center justify-center">
                  ...
                  <img src="/assets/images/julesgo-icon.svg" alt="JulesGo Ghost" className="w-24 h-24 drop-shadow-lg" />
                </div>
                <div className="p-8 flex-1 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    <h3 className="text-2xl font-bold text-slate-900">JulesGo</h3>
                  ...
                  <button className="w-full py-3 rounded-lg border-2 border-rgb-red text-rgb-red font-bold hover:bg-rgb-red hover:text-white transition-colors">
                    Learn More
                  </button>
                </div>
              </motion.div>
